...
Please follow the instructions in [Pinokio Tutorial](https://pinokio.co/docs/#/?id=install) to install Pinokio for [Windows](https://pinokio.co/docs/#/?id=windows), [Mac](https://pinokio.co/docs/#/?id=mac) or [Linux](https://pinokio.co/docs/#/?id=linux)
